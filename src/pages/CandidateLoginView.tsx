...
export default function CandidateLoginView() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (role !== UserRole.Candidate && role !== UserRole.Admin) {
        setError(
          isEnglish
            ? "This account is registered as an employer. Use the employer sign-in page."
            : "Цей акаунт зареєстрований як роботодавець. Увійди через сторінку входу для роботодавця.",
        );
        return;
      }
          ...
          <div className="relative z-10 flex flex-1 flex-col justify-center py-6">
            <div className="max-w-[490px]">
              ...
              <p className="mb-8 text-[14px] leading-relaxed text-[#A8B6CD] lg:text-[15px]">
                {isEnglish
                  ? "Sign in to manage your resume, applications, messages, and vacancy recommendations."
                  : "Увійди в кабінет кандидата, щоб керувати резюме, відгуками, повідомленнями та рекомендаціями вакансій."}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-1 flex-col justify-center">
            <div className="mx-auto w-full max-w-[400px]">
              ...
              <p className="mb-8 text-[14px] text-[#6B7D99]">
                {isEnglish
                  ? "Sign in to continue working with your profile."
                  : "Увійди в акаунт, щоб продовжити роботу з профілем."}
              </p>
